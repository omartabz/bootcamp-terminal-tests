...
describe('The mostProfitableDepartment function', function () {
    ...
    it('should return which department is the most profitable department from salesdataset 1', function () {
assert.equal('outdoor', mostProfitableDepartment(salesData), "Most profitable department is 'outdoor' for dataset 1");
    })
    it('should return which department is the most profitable one from salesDataset 2', function () {
